...
// command line compiling options
//cl.exe /FoUseXORLib ex13.cpp /linkXORLib.lib
//		/Fo<file> different file name for the output exe file
//		/link option to link the DLL (XORLib.lib and XORLib.dll created before for ex12.cpp file)
